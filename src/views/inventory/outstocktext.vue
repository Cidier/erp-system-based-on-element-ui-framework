<template>
    <div class="app-container" style="background-color: #dcdcdc;">
      <el-form ref="form" :model="form" label-width="120px">
        ...
        <el-col :span="10">
        <el-form-item label="出仓单ID">
          <el-input v-model="form.id"  readonly/>
        </el-form-item>
        </el-col>
        <el-col :span="12">
        <el-form-item label="销售单号ID">
          <el-input v-model="form.saleId" readonly/>
        </el-form-item>
        </el-col>
        <el-col :span="10">
        ...
        <el-form-item label="出仓数量">
            <el-input v-model="form.sumQuantity"  readonly/>
          </el-form-item>
        </el-col>
        <el-col :span="12">
        <el-form-item label="分切费">
            <el-input v-model="form.curPrice" readonly/>
        </el-form-item>
        </el-col>
        <el-col :span="10">
            ...
            <el-col :span="12">
                <el-form-item label="出仓日期">
                  <el-input v-model="form.outTime" readonly/>
                </el-form-item>
                </el-col>
                <el-col :span="10">
                <el-form-item label="签收时间">
                    <el-input v-model="form.signTime"  readonly/>
                  </el-form-item>
                </el-col>
            <el-col :span="12">
  ...
  />
    ...
    <el-dialog :visible.sync="addVisible">
      <el-form ref="dataForm" :model="dataForm" label-position="left" label-width="120px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="出仓数量" prop="quantity">
        ...
        <el-form-item label="件号"   prop="caseNo">
            <el-input v-model="dataForm.caseNo" />
          </el-form-item>
      </el-form>
  ...
  <script>
import { getList} from '@/api/outstock'
import { getListTest,addoutStockText,updateoutStockText,deleteoutStockText } from '@/api/outstocktext'
  ...
  export default {
    ...
    createGood() {
      this.$refs['dataForm'].validate((valid) => {
        this.dataForm.outId=this.form.id
        addoutStockText(this.dataForm).then(() => {
          this.$notify({
            title: 'Success',
            message: 'Created Successfully',
            type: 'success',
    ...
    editData() {
        this.dataForm.outId=this.form.id
        updateoutStockText(this.dataForm).then(() => {
          this.addVisible = false
          this.$notify({
            title: 'Success',
    ...
    Delete(row, index) {
      ...
      deleteoutStockText(row).then(response=>{
        this.$notify({
        title: 'Success',
